...
export const Icon = () => (
    <svg width="20" height="20" viewBox="0 0 24 24" fill="none" aria-hidden="true" className="opacity-95 text-white">
        <path d="M7 7h10v3H7zM7 11h10v3H7zM7 15h8v3H7z" fill="currentColor"/>
    </svg>
);
